...
class NodeEditorWindow(QMainWindow):
    ...
    def createActions(self):
        ...
        self.actCut = QAction('&Cut', self, shortcut='Ctrl+X', statusTip="Cut to clipboard", triggered=self.onEditCut)
        ...
        self.actDelete = QAction('&Delete', self, shortcut='Delete', statusTip="Delete selected items",
